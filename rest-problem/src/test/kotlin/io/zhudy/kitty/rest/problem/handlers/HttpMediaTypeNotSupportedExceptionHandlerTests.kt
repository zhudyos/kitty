 ...
 */
internal class HttpMediaTypeNotSupportedExceptionHandlerTests {

    @Test
    fun handle() {
        val handler = HttpMediaTypeNotSupportedExceptionHandler()
        val ex = HttpMediaTypeNotSupportedException("integration test")

 ...
 */
internal class MissingRequestParameterExceptionHandlerTests {

    @Test
    fun handle() {
        val handler = MissingRequestParameterExceptionHandler()
        val ex = MissingRequestParameterException(where = "query", parameter = "name")

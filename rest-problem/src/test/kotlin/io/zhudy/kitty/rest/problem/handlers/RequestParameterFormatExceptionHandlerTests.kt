 ...
 */
internal class RequestParameterFormatExceptionHandlerTests {

    @Test
    fun handle() {
        val handler = RequestParameterFormatExceptionHandler()
        val ex = RequestParameterFormatException(where = "query", parameter = "name", msg = "类型不匹配")
